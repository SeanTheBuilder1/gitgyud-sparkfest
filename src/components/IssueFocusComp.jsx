...
export default function IssueFocusComp({ report, comments, isAdmin }) {
        ...
        <div className="report-detail">
            ...
            <div className="detail-meta">
                ...
                <div className="meta-item">
                    ...
                    <span className="meta-value">
                        {report?.barangay_lookup_table ? report.barangay_lookup_table.barangay_name : "Unspecified Barangay"}
                    </span>
                </div>
            </div>
